...
public class StartAction implements ApplicationAction {
    ...
    public Application apply(Application application) {
        ...
        if (blocklistEnabled && launchResult.getStatus() != LaunchStatus.SUCCESS) {
            ...
            javaArchiveRepository.blockList(jarFile);
        ...
        if (launchResult.getStatus() == LaunchStatus.SUCCESS) {
            ...
            String version = javaArchiveRepository.getAllowlistVersion();
            if (version != null) {
                javaArchiveRepository.removeAllowlist(version);
            }
            javaArchiveRepository.allowlist(jarFile, application.getLatest().getVersion());
        }
