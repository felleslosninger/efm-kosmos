Feature: Synchronization - Early Bird
  ...
  Background:
    ...
    """
    And a "GET" request to "/service/local/artifact/maven/content?r=staging&g=no.difi.meldingsutveksling&a=integrasjonspunkt&v=1.8.0-SNAPSHOT&e=jar.asc" will respond with status "200" and the following "text/plain" in "/cucumber/success.jar.asc"
