Feature: Synchronization - Upgrade
  ...
  Background:
    ...
    sha1=06d4cfb40c1bfeb3ef8d4ccfd222defe7225d425
    """
    And the "integrasjonspunkt-1.7.92-SNAPSHOT.jar" exists as a copy of "/cucumber/success.jar"
    And the latest integrasjonspunkt version is "1.7.93-SNAPSHOT" with SHA-1 "39ba01879f7ededa62f7e5129f140089795e05bc"
