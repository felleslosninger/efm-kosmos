Feature: Synchronization - No integrasjonspunkt running on client
  ...
  Background:
    ...
    And the current version is unset
    ...
    """
    And a "GET" request to "/service/local/artifact/maven/content?r=staging&g=no.difi.meldingsutveksling&a=integrasjonspunkt&v=1.7.93-SNAPSHOT&e=jar.asc" will respond with status "200" and the following "text/plain" in "/cucumber/success.jar.asc"
